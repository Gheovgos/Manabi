...
public class VisualizzaTestDaCompilare {
	...
	private void initialize() {
		...
		txtpnElencoDeiTest.setFont(new Font("Tahoma", Font.BOLD, 11));
		txtpnElencoDeiTest.setText("ELENCO TEST COMPILABILI:");
		...
		lblNewLabel.setIcon(new ImageIcon(VisualizzaTestDaCompilare.class.getResource("/Immagini/SFONDO TUTTO.png")));
		lblNewLabel.setBounds(40, 0, 608, 562);

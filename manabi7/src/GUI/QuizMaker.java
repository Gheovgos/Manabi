...
public class QuizMaker {
	...
	private void initialize() {
		...
		warningMin.setForeground(SystemColor.textHighlight);
		...
		txtpnInserisciIlPunteggio.setForeground(SystemColor.textHighlight);
		...
		minSupMax.setForeground(SystemColor.textHighlight);
		...
		warningMul.setForeground(SystemColor.textHighlight);
		...
		txtpnLaDomandaNon.setForeground(SystemColor.textHighlight);
		...
		txtLaRispostaGiusta.setForeground(SystemColor.textHighlight);

...
runo QUESITI_MULTIPLI.R_UNOC%type;
idrm RISPOSTE_MULTIPLE.IDR_M%type;
piu QUESITI_MULTIPLI.PUNTEGGIO_ESATTO%TYPE;
meno QUESITI_MULTIPLI.PUNTEGGIO_ERRATO%TYPE;
...
SELECT QUESITI_MULTIPLI.R_UNOC, QUESITI_MULTIPLI.PUNTEGGIO_ERRATO, QUESITI_MULTIPLI.PUNTEGGIO_ESATTO INTO runo, piu, meno
FROM QUESITI_MULTIPLI
WHERE QUESITI_MULTIPLI.ID_M = idrm;
